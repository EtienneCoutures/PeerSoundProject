...
var PlaylistService = /** @class */ (function () {
    ...
    PlaylistService.prototype.getPlaylistMusics = function (playlistId) {
        return this.httpClient.get("http://localhost:8000/api/playlist/" + playlistId, { headers: this.headers });
    };
    PlaylistService.prototype.createPlaylist = function (pl) {
        pl.playlist_creator = this.account.usr_id;
        return this.httpClient.post('http://localhost:8000/api/playlist/', pl, { headers: this.headers });
    };
    PlaylistService.prototype.inviteUser = function (invitation) {
        return this.httpClient.post('http://localhost:8000/api/invitation', invitation, { headers: this.headers });
    };
    ...
    PlaylistService.prototype.getUserFromPlaylist = function (plId) {
        return this.httpClient.get("http://localhost:8000/api/playlist/users/" + plId, { headers: this.headers });
    };
    PlaylistService.prototype.getMusicLinkFromMusicId = function (id) {
        return this.httpClient.get("http://localhost:8000/api/musiclink"
